...
Sprite_Battler.prototype.setupBmotionFloat = function() {
        ...
        // NOTE: Bugfix (gil9red)
		// this._d = [0,0]; TODO
        this._battler._bmotion.idle.float._d = [0,0];
};
...
Sprite_Battler.prototype.updateBMotionFloat = function() {
    ...
    // NOTE: Bugfix (gil9red)
    //       Cannot set property '0' of undefined at Sprite_SvEnemy.Sprite_Battler.updateBMotionFloat
    ...
    if (this._battler._bmotion.idle.float.animation[0] == 0) {		  
        ...
        // NOTE: Bugfix (gil9red)
        // this._d[0] = 1;  
        this._battler._bmotion.idle.float._d[0] = 1;
      ...
      this._battler._bmotion.idle.float._d[0] = this._battler._bmotion.idle.float.animation[1] > 0 ? 0 : 1;

      // NOTE: Bugfix (gil9red)
      // if (this._d[1] != this._d[0]){
	  //    this._d[1] = this._d[0]
        if (this._battler._bmotion.idle.float._d[1] != this._battler._bmotion.idle.float._d[0]) {
	      this._battler._bmotion.idle.float._d[1] = this._battler._bmotion.idle.float._d[0];
